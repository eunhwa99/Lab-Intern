...
public class AmbientTemperatureActivity extends AppCompatActivity implements SensorEventListener {
    ...
    TextView txvCurrAmbientTemperatureData, txvMaxAmbientTemperatureData, txvMinAmbientTemperatureData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txvCurrAmbientTemperatureData = (TextView) findViewById(R.id.txvCurrAmbientTemperatureData);
        txvMaxAmbientTemperatureData = (TextView) findViewById(R.id.txvMaxAmbientTemperatureData);
        txvMinAmbientTemperatureData = (TextView) findViewById(R.id.txvMinAmbientTemperatureData);

        sensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
        ambientTemperatureSensor = sensorManager.getDefaultSensor(Sensor.TYPE_AMBIENT_TEMPERATURE);
        lineChart = (LineChart) findViewById(R.id.ambientTemperatureChart);
    ...
    private void threadStart() {
        AmbientTemperatureActivity.MyThread thread = new AmbientTemperatureActivity.MyThread();
    ...
    protected void onResume(){
        super.onResume();
        sensorManager.registerListener(this, ambientTemperatureSensor, SensorManager.SENSOR_DELAY_FASTEST);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        txvCurrAmbientTemperatureData.setText("℃ : "+cx);
        txvMaxAmbientTemperatureData.setText("℃ : "+maxdata);
        txvMinAmbientTemperatureData.setText("℃ : "+mindata);
    }

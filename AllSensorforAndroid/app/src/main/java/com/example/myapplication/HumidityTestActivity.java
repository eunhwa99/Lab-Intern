...
public class HumidityTestActivity extends AppCompatActivity implements SensorEventListener {
    private SensorManager sensorManager;
    private Sensor humiditySensor;
    private LineChart lineChart;
    int DATA_RANGE = 1000;

    TextView txvCurrHumidityData, txvMaxHumidityData, txvMinHumidityData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humidity_test);

        txvCurrHumidityData = (TextView) findViewById(R.id.txvCurrHumidityData);
        txvMaxHumidityData = (TextView) findViewById(R.id.txvMaxHumidityData);
        txvMinHumidityData = (TextView) findViewById(R.id.txvMinHumidityData);

        sensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
        humiditySensor = sensorManager.getDefaultSensor(Sensor.TYPE_RELATIVE_HUMIDITY);
        lineChart = (LineChart) findViewById(R.id.humidityChart);
    ...
    private void threadStart() {
        HumidityTestActivity.MyThread thread = new HumidityTestActivity.MyThread();
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        txvCurrHumidityData.setText("% : "+cx);
        txvMaxHumidityData.setText("% : "+maxdata);
        txvMinHumidityData.setText("% : "+mindata);
    }

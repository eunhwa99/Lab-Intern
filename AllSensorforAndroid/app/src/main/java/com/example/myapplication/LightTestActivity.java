...
public class LightTestActivity extends AppCompatActivity implements SensorEventListener {
    ...
    TextView txvCurrLightData, txvMaxLightData, txvMinLightData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txvCurrLightData = (TextView) findViewById(R.id.txvCurrLightData);
        txvMaxLightData = (TextView) findViewById(R.id.txvMaxLightData);
        txvMinLightData = (TextView) findViewById(R.id.txvMinLightData);

        sensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
        lightSensor = sensorManager.getDefaultSensor(Sensor.TYPE_LIGHT);
        lineChart = (LineChart) findViewById(R.id.LightChart);
    ...
    private void threadStart() {
        LightTestActivity.MyThread thread = new LightTestActivity.MyThread();
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        txvCurrLightData.setText("LX : "+cx);
        txvMaxLightData.setText("LX : "+maxdata);
        txvMinLightData.setText("LX : "+mindata);
    }
